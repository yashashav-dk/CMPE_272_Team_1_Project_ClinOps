...
export async function GET(
  ...
  try {
    ...
    // Use the widgets retrieved from the database. Do not synthesize default widgets here
    // so that clearing all widgets results in an empty dashboard as expected.
    const effectiveWidgets = widgets
